...
#added by MAZ- overwrite existing output files or no? 
OVERWRITE:int = 1
...
SAMPLE_RATE: int = 16000 #48000

# We're using 3-second chunks
SIG_LENGTH: float = 144000 / SAMPLE_RATE #3.0

# Define overlap between consecutive chunks <3.0; 0 = no overlap;
#with 16000 sample rate, this can actually be <9.0
SIG_OVERLAP: float = 0
